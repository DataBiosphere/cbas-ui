...
describe('submission-common tests', () => {
  it('variable type text is rendered properly', () => {
    ...
    expect(renderTypeText({ type: 'optional', optional_type: { primitive_type: 'String' } })).toStrictEqual('String (optional)')
    expect(renderTypeText({ type: 'array', array_type: { primitive_type: 'Int' } })).toStrictEqual('Array[Int]')
