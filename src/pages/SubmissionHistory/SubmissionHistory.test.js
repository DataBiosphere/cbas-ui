...
describe('SubmissionHistory page', () => {
  ...
  it('should correctly display previous 2 run sets', async () => {
    ...
    within(cellsFromDataRow1[headerPosition['Submission name']]).getByText('Data used: FOO')
    within(cellsFromDataRow1[headerPosition['Submission name']]).getByText('1 workflows')
    ...
    within(cellsFromDataRow2[headerPosition['Submission name']]).getByText('Data used: FOO')
