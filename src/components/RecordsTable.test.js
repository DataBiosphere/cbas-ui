...
describe('RecordsTable', () => {
  ...
  it('Render data as expected', async () => {
    ...
    within(dataRow[9]).getByText('["https://datasettoaexample.blob.core.windows.net/dataset/abc.fastq.gz","https://datasettoaexample.blob.core.windows.net/dataset/xyz.fastq.gz"]')
