...
export const reconstructToRawUrl = (methodPath, methodVersion, methodSource) => {
  return Utils.cond(
    ...
    () => {
      throw new Error(`Unknown method source found. Currently supported method sources are [${MethodSource.GitHub}, ${MethodSource.Dockstore}].`)
    }
  )
}
